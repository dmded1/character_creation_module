...
def attack(char_name: str, char_class: str) -> str:
    """Calculate attack skill and return message with value."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate defence skill and return message with value."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate special skill and return message with value."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Print options of training in case of choosen class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Entering a character name and choosing a class."""
