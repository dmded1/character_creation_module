...
def add_rep(current_rep: float, rep_points: int,
...
def main(duel_res: list[tuple[int, str, bool]]):
    current_rep = 0.0
    ...
    return str(f'После {len(duel_res)} поединков, '
               f'репутация персонажа — {current_rep} очков.')
